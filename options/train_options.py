...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoint_dir', type=str, default='', help='models are saved here')
        self.parser.add_argument('--load_model_dir', type=str, default='', help='pretrained models are given here')
        self.parser.add_argument('--phase', type=str, default='train')

        # input/output sizes
        self.parser.add_argument('--batch_size', default=4, type=int, help='input batch size')
        ...
        self.parser.add_argument('--mask_type', type=str, default='')
        ...
        self.parser.add_argument('--lambda_style', type=float, default=250)
        self.parser.add_argument('--lambda_content', type=float, default=0.1)

        self.parser.add_argument('--lambda_l1', type=float, default=1.0)
        self.parser.add_argument('--lambda_percep', type=float, default=0.1)

        self.parser.add_argument('--adv_weight', type=float, default=0.01, help='loss weight for adversarial loss')
        ...
        self.parser.add_argument('--gamma', type=int, default=2)
